...
def codemap_file(path: str, max_nodes: int = 30, user: User = CurrentUser) -> dict:
...
def codemap_explain_edge(body: ExplainEdgeBody, user: User = CurrentUser) -> dict:
    with session_scope() as s:
...
def codemap_extend(body: ExtendCodemapBody, user: User = CurrentUser) -> dict:
    with session_scope() as s:
...
def codemap_simulate(body: SimulateBody, user: User = CurrentUser) -> dict:
